      ...
      builder: (context, viewModel, child) {
        return Scaffold(
          appBar: AppBar(
            ...
            title: Text("Add New Job", style: PTextStyles.displayMedium),
            centerTitle: true,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomElavatedTextButton(
                            text: "Publish Job",
                            onPressed: () async {
                              final success = await viewModel.publishJob();
                              ...
                              } else if (!success && context.mounted && viewModel.errorMessage.isNotEmpty) {
                                // Error message already displayed in the error container
                              }
                            },
                          ),
                          SizeBoxH(20),
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: Icon(Icons.close, size: 16, color: PColors.primaryColor),
                  ),
                ],
              ),
            ),
