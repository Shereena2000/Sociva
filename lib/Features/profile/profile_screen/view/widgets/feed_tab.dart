...
class FeedTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        // Grid layout like Photos tab - feedPosts already filtered to only include posts with media
        return MasonryGridView.count(
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              onTap: () {
                // Navigate to FeedCardDetailScreen with all feed post IDs
                final allFeedPostIds = feedPosts.map((p) => p.postId).toList();
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => FeedCardDetailScreen(
                      feedId: post.postId,
                      feedIds: allFeedPostIds,
                      initialIndex: index,
                    ),
                  ),
                );
  ...
  Widget _buildFeedPostItem(PostModel post) {
