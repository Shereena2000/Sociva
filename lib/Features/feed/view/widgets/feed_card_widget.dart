...
class FeedCardWidget extends StatelessWidget {
  ...
  final VoidCallback? onTap; // Optional tap callback (for navigation to detail screen)
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: onTap ?? () {
        // Default navigation if no custom callback provided
        Navigator.push(
          context,
          MaterialPageRoute(
        ...
        child: Column(
          ...
          children: [
            ...
            if (postWithUser.post.isQuotedRetweet && postWithUser.post.quotedPostData != null)
              _buildQuotedPostPreview(context, postWithUser.post.quotedPostData!),
  ...
  Widget _buildQuotedPostPreview(BuildContext context, Map<String, dynamic> quotedPostData) {
  ...
  void _showPostOptionsMenu(
      BuildContext context, PostWithUserModel postWithUser, FeedViewModel feedViewModel) {
    final currentUserId = FirebaseAuth.instance.currentUser?.uid ?? '';
  ...
  Future<void> _confirmDeletePost(
      BuildContext context, PostWithUserModel postWithUser, FeedViewModel feedViewModel) async {
